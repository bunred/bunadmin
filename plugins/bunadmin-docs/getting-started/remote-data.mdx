...
4. Learn how to use the components: ListSelector, Uploader, Notice, MultipleSelector.

***The tutorial is still in preparation, currently using the sample plugin instead. [`bunadmin-plugin-example-blog`](https://github.com/bunred/bunadmin/tree/master/plugins/bunadmin-plugin-example-blog)***
